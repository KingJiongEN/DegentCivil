...
@register(name='PERSPQ', type="state")
class PerspectQuestionState(BaseState):
    def __init__(self, character: Character, character_list: CharacterList, building_list: BuildingList,
                 on_change_state,
                 state_name: str = CharacterState.PERSPQ,
                 main_prompt=PromptType.Perspect_Quest,
                 followed_states=[CharacterState.PERSPA],
                 enter_calls=None, 
                 exit_calls=None, 
                 update_calls=None, 
                 llm_calls=None,
